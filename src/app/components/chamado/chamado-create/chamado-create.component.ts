...
export class ChamadoCreateComponent implements OnInit {
  ...
  constructor(private clienteService: ClienteService, private tecnicoService: TecnicoService, private service: ChamadoService, private toast: ToastrService, private router: Router) { }
